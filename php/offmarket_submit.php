...
// Insert car into database with status = 'offmarket' (bypasses approval)
$stmt = $pdo->prepare("INSERT INTO cars 
    (name, model, price, year, mileage, int_colour, ext_colour, description, status, submitted_by) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'offmarket', ?)");
...
header("Location: ../dashboard.php?success=offmarket_added");
exit;
