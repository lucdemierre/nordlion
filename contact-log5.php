<?php
session_start();
$is_logged_in = isset($_SESSION['user_id']); // Adjust as needed
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<?php if ($is_logged_in): ?>
<div class="contact-container" style="padding: 40px 60px;">
    ...
    <div class="contact-form" style="flex: 1.2; max-width: 600px;">
...
<?php endif; ?>
                ...
                <div class="faq-section" style="margin-top: 80px;">
                    ...
                    <div class="faq-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px; margin-top: 40px;">
                        <div class="faq-item" style="background: white; padding: 30px; border-radius: 10px; box-shadow: var(--box-shadow);">
                        ...
                        <div class="faq-item" style="background: white; padding: 30px; border-radius: 10px; box-shadow: var(--box-shadow);">
                            ...
                            <p>Yes, we offer virtual consultations via video call for clients who prefer remote meetings or are located in different time zones.</p>
                        </div>
                        <div class="faq-item" style="background: white; padding: 30px; border-radius: 10px; box-shadow: var(--box-shadow);">
                            <h3 style="color: var(--primary-color); margin-bottom: 15px;">What information should I prepare?</h3>
                            <p>Please have your basic contact information ready, along with any specific details about the vehicle or service you're interested in.</p>
                        </div>
                    </div>
                </div>
            </div>
