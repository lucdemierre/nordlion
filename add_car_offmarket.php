...
<head>
  <meta charset="UTF-8">
  <title>Add Car to Off-Market | NordLion International</title>
  ...
  <style>
    ...
    .image-entry textarea { width: 100%; margin-top: 10px; }
    .image-entry .remove-btn {
      position: absolute; top: 8px; right: 8px; background: transparent; border: none;
      font-size: 1.2rem; cursor: pointer; color: #c00;
    }
    .form-group label { display: block; margin-bottom: 6px; font-weight: 600; }
    .form-group input, .form-group textarea {
      width: 100%; padding: 8px; font-size: 1rem; margin-bottom: 15px; border-radius: 4px; border: 1px solid #ccc;
    }
    .btn-secondary { background-color: #eee; border: 1px solid #aaa; padding: 8px 12px; border-radius: 4px; cursor: pointer; }
...
<body>
  ...
  <main class="section-padding" style="max-width: 800px; margin: auto;">
    <h1 class="section-heading">Add Car to Off-Market</h1>
    <form action="php/offmarket_submit.php" method="POST" enctype="multipart/form-data" class="form">
      <!-- 🔑 make this an off-market car -->
      <input type="hidden" name="status" value="offmarket">
