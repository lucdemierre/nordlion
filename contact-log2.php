...
<head>
    ...
    <link rel="stylesheet" href="css/<?php echo $isLoggedIn ? 'mop_dashboard.css' : 'contact.css'; ?>">
        ...
        <div class="container">
            ...
            <div class="dashboard-grid">
                ...
                <div class="card">
                    ...
                    <a href="offmarket_inquiries_admin.php" class="btn btn-primary">Manage Users</a>
                </div>
            </div>
        </div>
    </section>
